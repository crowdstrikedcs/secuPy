        ...
        try:
            ...
            if flag==False:
                ...
                if label==0 and normalCount<20001:
                    ...
                    trainData.append([float(dur), protoDict[proto], int(Sport), int(Dport), Sip, Dip, int(totP), int(totB), stateDict[state]])
                ...
                if label==0 and testNormal<5001:
                    testData.append([float(dur), protoDict[proto], int(Sport), int(Dport), Sip, Dip, int(totP), int(totB), stateDict[state]])
